...
export default function DiaporamaContent() {
    ...
    <div className="bg-black min-h-screen text-white flex flex-col items-center justify-center md:p-6">
      ...
      <div className="relative w-full md:max-w-3xl aspect-[4/3] mb-4 md:mb-6 flex items-center justify-center">
        ...
        <button
          ...
          className="absolute left-2 md:left-4 p-3 rounded-full bg-white/10 hover:bg-white/20 transition z-20"
        ...
        <button
          onClick={() => goTo(currentIndex + 1)}
          className="absolute right-2 md:right-4 p-3 rounded-full bg-white/10 hover:bg-white/20 transition z-20"
